                ...
                <div className='modal_content'>
                    <div className='modal_content_calendar_box'>
                        <div className='modal_content_calendar'>
                            <Calendar onChange={setDate} value={date} calendarType='US'></Calendar>
                        </div>
                    </div>
                    <div className='modal_content_select'>
                        <div className='modal_content_selected_date'>
                            <div className={(beforeOrAfter === "AM") ? 'modal_content_time_btn_clicked' : 'modal_content_time_btn'}>
                                <div className='modal_content_time_text' onClick={()=>setBeforeOrAfter("AM")}>오전</div>
                            </div>
                            <div className={(beforeOrAfter === "PM") ? 'modal_content_time_btn_clicked' : 'modal_content_time_btn'}>
                                <div className="modal_content_time_text" onClick={()=>setBeforeOrAfter("PM")}>오후</div>
                            </div>
                            <div className='modal_content_day'>{date.getDate()}</div>
                            <div className='modal_content_month_year'>{numToName(date.getMonth())}</div>
                            <div className='modal_content_month_year'>{date.getFullYear()}</div>
                        </div>
                        <div className='modal_content_select_box'>
                            ...
                            <div className='modal_content_select_time'>
                                <div className='select_before'>
                                    <div className="select_before_icon" onClick={()=>upBtnClicked()}></div>
                                </div>
